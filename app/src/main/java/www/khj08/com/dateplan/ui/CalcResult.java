...
public class CalcResult extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header = getLayoutInflater().inflate(R.layout.content_calc_result02, null, false);
        first_name_calc = (TextView)header.findViewById(R.id.first_name_calc);
        second_name_calc = (TextView)header.findViewById(R.id.second_name_calc);
